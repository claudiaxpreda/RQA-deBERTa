...
from prepare_dataset_llama import get_input_qg

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
HUGGING_TOKEN = "hf_{}"
API_KEY_WB = "{}"
BASE_MODEL = "meta-llama/Llama-3.2-3B"
FINETUNED_MODEL = "llama32-3b_qgen_ft"
LR = 5e-5
...
train_data = get_input_qg('train', HUGGING_TOKEN)
val_data = get_input_qg('validation', HUGGING_TOKEN)
